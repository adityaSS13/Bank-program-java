...
public class bankTests {
    ...
    public void setup() {
      ...
      public void successfulTransaction() {
          bank.executeTransaction(new Transaction(1546905600, Transaction.Type.WITHDRAW, "f84c43f4-a634-4c57-a644-7602f8840870", 624.99));
          bank.executeTransaction(new Transaction(1578700800, Transaction.Type.DEPOSIT, "f84c43f4-a634-4c57-a644-7602f8840870", 441.93));
          assertEquals(2, bank.getTransactions("f84c43f4-a634-4c57-a644-7602f8840870").length);
      }

      @Test
      public void failedTransaction(){
        this.bank.executeTransaction(new Transaction(1546905600, Transaction.Type.WITHDRAW, "f84c43f4-a634-4c57-a644-7602f8840870", 10000000));
      ...
      public void taxDeduction(){
        ...
        */
        this.bank.executeTransaction(new Transaction(1578700800, Transaction.Type.DEPOSIT, "f84c43f4-a634-4c57-a644-7602f8840870", 4000));
        this.bank.executeTransaction(new Transaction(1578700800, Transaction.Type.WITHDRAW, "f84c43f4-a634-4c57-a644-7602f8840870", 500));
